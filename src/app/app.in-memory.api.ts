      ...
      polls: [
        {
          ...
          description: `Horizon Zero Dawn is an action role-playing video poll
                   developed by Guerrilla polls and published by Sony Interactive Entertainment
                   ...
                   The poll features an open world environment for Aloy to explore,
        ...
        },
        {
          ...
          description: `Destiny 2 is an online-only multiplayer first-person shooter
                    video poll developed by Bungie and published by Activision. It was released
        ...
        },
        {
          ...
          description: `Gran Turismo Sport is the latest entry in the long-running
                    simulation racing series, and its no doubt going to be another
                     ...
                     whatever Sonys current poll console is.`
        },
        {
          id: 4,
          ...
          platforms: [1, 2, 3],
          descripion: `Resident Evil 7: Biohazard[a] is a survival horror video poll developed
                   and published by Capcom. The poll was released worldwide in January 2017 for Microsoft
        ...
        },
        {
          ...
          platforms: [1, 2, 3],
          description: `Call of Duty: WWII is a first-person shooter video poll developed by
                   Sledgehammer polls and published by Activision. It is the fourteenth main installment in
                    the Call of Duty series and was released worldwide on November 3, 2017 for Microsoft
                     Windows, PlayStation 4 and Xbox One. It is the first title in the series to be set
                      primarily during World War II since Call of Duty: World at War in 2008.[2] The poll is
        ...
        },
        {
          ...
          platforms: [2],
          description: `Uncharted: The Lost Legacy is an action-adventure poll developed by Naughty Dog and
                   published by Sony Interactive Entertainment. Released in August 2017 for the PlayStation 4,
                    it is a standalone expansion to the Uncharted series, and is the first poll not to
                     feature protagonist Nathan Drake. The poll follows fortune hunter Chloe Frazer, who seeks
                      the Tusk of Ganesh in the mountains of India in the midst of a civil war, with the help
                       of ex-mercenary Nadine Ross and Nathans brother Sam Drake. The poll is played from a
                        third-person perspective; players use firearms, and can use melee combat and stealth
                         to defend against hostile enemies. Players solve puzzles, incorporating several
                          platformer elements to advance the narrative, and navigate the poll world on foot or by vehicle.`
        },
        {
          id: 7,
          ...
          platforms: [1, 2, 3],
          description: `Assassins Creed Origins is an action-adventure video poll developed by
                   Ubisoft Montreal and published by Ubisoft. It is the tenth major installment in the
                    Assassins Creed series and the successor to 2015s Assassins Creed Syndicate.
                     It was released worldwide for Microsoft Windows, PlayStation 4, and Xbox One on
                      October 27, 2017. The poll is set in Egypt during the near end of the Ptolemaic period
        ...
        },
        {
          ...
          platforms: [2],
          description: `Crash Bandicoot N. Sane Trilogy is a platform video poll compilation
                   developed by Vicarious Visions and published by Activision for PlayStation 4. It is a
                    collection of remasters of the first three titles in the Crash Bandicoot series: Crash
                     Bandicoot, Cortex Strikes Back, and Warped, which were originally developed by Naughty
                      Dog for PlayStation in the 1990s. The poll was released on June 30, 2017, receiving
                       generally favorable reviews from critics, who praised the polls faithfulness to the
        ...
        },
        {
          ...
          platforms: [1, 2, 3],
          description: `Star Wars Battlefront II is an action shooter video poll based on the
                   Star Wars film franchise. It is the fourth major installment of the Star Wars:
                    Battlefront series and seventh overall, and a sequel to the 2015 reboot of the series.
                     It was developed by EA DICE, in collaboration with Criterion polls and Motive Studios,
                      and published by Electronic Arts. The poll was released worldwide on November 17,
        ...
        },
        {
          ...
          releaseDate: '2017-10-17',
          platforms: [1, 2, 3],
          description: `South Park: The Fractured but Whole is a 2017 role-playing video poll
                   developed by Ubisoft San Francisco and published by Ubisoft in collaboration with
                    South Park Digital Studios. Based on the American adult animated television series
                     South Park, it is the sequel to the 2014 video poll South Park: The Stick of Truth.
                      The polls narrative occurs one day after the events of its predecessor; it follows
                       the New Kid, who has recently moved to South Park and becomes involved in an epic
                        roleplay involving two rival superhero factions vying to create their own
                         superhero media franchises. The superheroes poll unintentionally uncovers a
        ...
        },
        {
          ...
          description: `Drawn to Death is a third-person shooter combined with a brawler
                   arena multiplayer video poll for PlayStation 4, developed by David Jaffes studio
        ...
        },
        {
          ...
          description: `Ark: Survival Evolved (stylized as ΛRK) is an action-adventure
                   survival video poll developed by Studio Wildcard in collaboration with Instinct
                    polls, Efecto Studios, and Virtual Basement. It was released in August 2017
                     for PlayStation 4, Xbox One, Microsoft Windows, OS X and Linux. In the poll,
        ...
        },
        {
          ...
          description: `Wolfenstein II: The New Colossus is an action-adventure
                   first-person shooter video poll developed by Machinepolls and published
                    by Bethesda Softworks. It was released on 27 October 2017 for Microsoft
                     Windows, PlayStation 4, and Xbox One, and is scheduled for release in 2018
                      for Nintendo Switch. The poll is the eighth main entry in the Wolfenstein
